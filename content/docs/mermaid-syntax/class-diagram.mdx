...
<Callout type="warning">
 This page is a reference for the Mermaid syntax for Class Diagram. For a more detailed explanation of the syntax, visit the [official Mermaid documentation](https://mermaid.js.org/syntax/classDiagram.html).
</Callout>
